      ...
      {salespersonsData.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {salespersonsData.map((salesperson) => {
            ...
            return (
              <div key={salesperson.id} className="flex items-center gap-3 p-3 rounded-lg border bg-card hover:bg-accent/50 transition-colors group">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2">
                    <h4 className="font-medium text-sm truncate">{salesperson.name}</h4>
